...
class acf_field_fonticonpicker extends acf_field {
	...
	function __construct() {
    	...
    	// Settings
		$this->settings = array(
			'dir' 		=>  get_stylesheet_directory_uri() . '/assets/acf-fonticonpicker/' . __FILE__,
			'path'		=>	get_stylesheet_directory_uri() . '/assets/acf-fonticonpicker/' . __FILE__,
			'config' 	=> 	get_stylesheet_directory_uri() . '/assets/acf-fonticonpicker/icons/config.json',
			'icons'		=>	get_stylesheet_directory_uri() . '/assets/acf-fonticonpicker/icons/css/fontello.css',
			'version' 	=> 	'1.0.0'
		);
