				...
				<article <?php post_class( 'row row-nogap' ); ?>>
					...
					<div class="ondernemers-post-section-right col-sm-9">
						...
						<footer class="ondernemers-footer">
							<span
								class="ondernemers-info"><?= 'w: <a target="_blank" href="' . get_field( 'bedrijfswebsite' ) . '">' . Extras\get_display_url( get_field( 'bedrijfswebsite' ) ) . '</a>'; ?></span>
							<span class="ondernemers-info"><?= 't: ' . get_field( 'telefoonnummer' ); ?></span>
							<span
								class="ondernemers-info"><?= 'e: <a href="mailto:' . get_field( 'e-mailadres' ) . '">' . get_field( 'e-mailadres' ) . '</a>'; ?></span>
						</footer>
					</div>
				</article>
